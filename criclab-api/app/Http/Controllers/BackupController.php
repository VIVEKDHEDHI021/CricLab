            ...
            DB::transaction(function () use ($data, $currentUserId, $userExists) {
                ...
                foreach ($data['players'] as $row) {
                    ...
                    $player->forceFill([
                        ...
                        'profile_photo' => $row['profile_photo'] ?? $row['avatar'] ?? null,
                        'avatar' => $row['profile_photo'] ?? $row['avatar'] ?? null,
                        'bio' => $row['bio'] ?? null,
                        'primary_role' => $row['primary_role'] ?? $row['role'] ?? null,
                        'role' => $row['primary_role'] ?? $row['role'] ?? null,
                        'batting_style' => $row['batting_style'] ?? null,
                        'bowling_style' => $row['bowling_style'] ?? null,
                        'bowling_type' => $row['bowling_type'] ?? null,
                        'jersey_number' => $row['jersey_number'] ?? null,
                        'preferred_team_id' => $row['preferred_team_id'] ?? $row['team_id'] ?? null,
